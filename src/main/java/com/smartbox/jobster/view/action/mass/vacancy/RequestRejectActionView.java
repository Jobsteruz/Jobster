...
@Route(value = "request-reject-action-view", layout = MainView.class)
@ViewController(id = "jb_RequestRejectActionView")
@ViewDescriptor(path = "request-reject-action-view.xml")
@DialogMode(width = "30em", height = "AUTO")
public class RequestRejectActionView extends StandardView {
    @Setter
