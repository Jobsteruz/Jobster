package com.smartbox.jobster.view.reports.funnelv2;
...
@Route(value = "funnel-v2", layout = MainView.class)
@ViewController(id = "jb_FunnelV2")
@ViewDescriptor(path = "funnel-v2.xml")
public class FunnelV2 extends AbstractHasPeriodReport {
    @Autowired
