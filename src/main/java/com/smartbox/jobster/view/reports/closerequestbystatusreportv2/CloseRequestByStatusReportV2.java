...
@Route(value = "close-request-by-status-report-v2", layout = MainView.class)
@ViewController(id = "jb_CloseRequestByStatusReportV2")
@ViewDescriptor(path = "close-request-by-status-report-v2.xml")
public class CloseRequestByStatusReportV2 extends AbstractHasPeriodReport {
    ...
    @ViewComponent
    private JmixSelect<String> dateFilterField;

    private static final String DATE_FILTER_VERIFIED = "verifiedDate";
    private static final String DATE_FILTER_CLOSED = "closedDate";
    private static final String DATE_FILTER_CREATED = "createdDate";
    private static final String DATE_FILTER_FILL = "fillDate";
    @ViewComponent
    ...
    private List<KeyValueEntity> allItems = Collections.emptyList();
    ...
    private void initDateFilterField() {
        // Реализация не публикуется: коммерческая тайна.
        throw new UnsupportedOperationException("Implementation not published");
    }

    private void hideFirstLastButtons() {
        // Реализация не публикуется: коммерческая тайна.
        throw new UnsupportedOperationException("Implementation not published");
    }

    private List<KeyValueEntity> reportDlLoadDelegate(ValueLoadContext loadContext) {
        // Реализация не публикуется: коммерческая тайна.
        throw new UnsupportedOperationException("Implementation not published");
    }
    ...
    @Subscribe("dateFilterField")
    public void onDateFilterFieldComponentValueChange(final AbstractField.ComponentValueChangeEvent<JmixSelect<String>, String> event) {
        // Реализация не публикуется: коммерческая тайна.
        throw new UnsupportedOperationException("Implementation not published");
    }
    ...
    private void loadClosedApplicantsCache() {
        // Реализация не публикуется: коммерческая тайна.
        throw new UnsupportedOperationException("Implementation not published");
    }
    ...
    private List<Applicant> getClosedApplicants(UUID requestId) {
        // Реализация не публикуется: коммерческая тайна.
        throw new UnsupportedOperationException("Implementation not published");
    }
