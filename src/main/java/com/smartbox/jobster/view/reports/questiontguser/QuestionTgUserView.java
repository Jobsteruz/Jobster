package com.smartbox.jobster.view.reports.questiontguser;
...
@Route(value = "question-tg-user-view", layout = MainView.class)
@ViewController("jb_QuestionTgUserView")
@ViewDescriptor("question-tg-user-view.xml")
public class QuestionTgUserView extends AbstractHasPeriodReport {
    @Autowired
