...
@Route(value = "attendance-report-view", layout = MainView.class)
@ViewController(id = "jb_AttendanceReportView")
@ViewDescriptor(path = "attendance-report-view.xml")
public class AttendanceReportView extends AbstractHasPeriodReport {

    @ViewComponent
    private CollectionContainer<AggregatedAttendanceReportDto> attendancesDc;
