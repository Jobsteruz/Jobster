...
@Route(value = "recruitment-and-dismissal-view", layout = MainView.class)
@ViewController("jb_RecruitmentAndDismissalView")
@ViewDescriptor("recruitment-and-dismissal-view.xml")
public class RecruitmentAndDismissalView extends AbstractHasPeriodReport {
    ...
    public List<RoleType> getInternRoleTypes() {
        // Реализация не публикуется: коммерческая тайна.
        throw new UnsupportedOperationException("Implementation not published");
    }
