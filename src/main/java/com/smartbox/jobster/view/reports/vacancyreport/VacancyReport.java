package com.smartbox.jobster.view.reports.vacancyreport;
...
@Route(value = "vacancy-report", layout = MainView.class)
@ViewController(id = "jb_VacancyReport")
@ViewDescriptor(path = "vacancy-report.xml")
public class VacancyReport extends AbstractHasPeriodReport {
    @ViewComponent
    ...
    private Renderer<KeyValueEntity> entityDataGridCreatedDateRenderer() {
        // Реализация не публикуется: коммерческая тайна.
        throw new UnsupportedOperationException("Implementation not published");
    }
    ...
    @Supply(to = "entityDataGrid.hireDate", subject = "renderer")
    private Renderer<KeyValueEntity> entityDataGridHireDateRenderer() {
        // Реализация не публикуется: коммерческая тайна.
        throw new UnsupportedOperationException("Implementation not published");
    }
