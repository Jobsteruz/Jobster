...
@Route(value = "ishgo-categories", layout = MainView.class)
@ViewController(id = "jb_IshgoCategory.list")
@ViewDescriptor(path = "ishgo-category-list-view.xml")
@DialogMode(width = "64em")
public class IshgoCategoryListView extends AbstractNavigationListView<IshgoCategory> {
    @Autowired
    ...
    @ViewComponent
    private CollectionLoader<IshgoCategory> entityDl;
    @ViewComponent
    ...
    @Override
    public CollectionLoader<IshgoCategory> dataLoader() {
        // Реализация не публикуется: коммерческая тайна.
        throw new UnsupportedOperationException("Implementation not published");
    }
