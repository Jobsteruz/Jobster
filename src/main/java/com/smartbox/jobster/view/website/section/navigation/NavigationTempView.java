...
@Route(value = "navigation-temp-view", layout = MainView.class)
@ViewController("jb_NavigationTempView")
@ViewDescriptor("navigation-temp-view.xml")
@CssImport("./webQur/navigation-section.css")
public class NavigationTempView extends StandardView {
    @Setter
    private Page page;
