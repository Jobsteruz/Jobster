...
@Route(value = "applicants/nightingale", layout = MainView.class)
@ViewController(id = "jb_ApplicantNightingaleListView")
@ViewDescriptor(path = "applicant-nightingale-list-view.xml")
public class ApplicantNightingaleListView extends AbstractApplicantListView {
