...
/**
 * @author Jobster team
 * Since: 6/25/2024 1:51 PM
 */
public class SendAutoFillTemp2Person extends AbstractJbKanbanAction {
    ...
    public SendAutoFillTemp2Person() {
    ...
    private List<Platform> geTempPlatforms(Map<String, String> params, List<Platform> platforms) {
        // Реализация не публикуется: коммерческая тайна.
        throw new UnsupportedOperationException("Implementation not published");
    }
}
