...
/**
 * @author Jobster team
 * Since: 3/21/2025 2:50 PM
 */
public class SendAutoFillTemp2VacancyUser extends AbstractJbKanbanAction {
    ...
    private VerticalLayout vacancyUserLayout() {
        // Реализация не публикуется: коммерческая тайна.
        throw new UnsupportedOperationException("Implementation not published");
    }
    ...
    private VacancyUser getVacancyUser(Map<String, String> params) {
        // Реализация не публикуется: коммерческая тайна.
        throw new UnsupportedOperationException("Implementation not published");
    }
