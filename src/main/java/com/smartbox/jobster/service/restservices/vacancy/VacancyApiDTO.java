...
public record  VacancyApiDTO(String id, UUID request, UUID department, UUID position,
                            ...
                            String salaryMax, String currency, UUID responsible, UUID author,UUID verifier,UUID form, String condition,
