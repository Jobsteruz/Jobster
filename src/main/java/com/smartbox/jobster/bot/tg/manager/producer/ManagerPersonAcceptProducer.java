...
/**
 * @author Jobster team
 * Since: 12/26/2025 10:50 AM
 */
public class ManagerPersonAcceptProducer extends AbstractManagerBotObject implements Producer {
    private final KanbanStageEntity stageEntity;

    public ManagerPersonAcceptProducer(BotContext botContext, KanbanStageEntity stageEntity) {
