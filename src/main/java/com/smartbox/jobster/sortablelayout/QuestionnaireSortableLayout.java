...
public class QuestionnaireSortableLayout extends Div {
     ...
     */
    public QuestionnaireSortableLayout(Component layout) {
        // Реализация не публикуется: коммерческая тайна.
        throw new UnsupportedOperationException("Implementation not published");
    }

    public QuestionnaireSortableLayout(Component layout, SortableConfig config) {
        // Реализация не публикуется: коммерческая тайна.
        throw new UnsupportedOperationException("Implementation not published");
    }

    public QuestionnaireSortableLayout(Component layout, SortableConfig config, SortableGroupStore groupStore) {
        // Реализация не публикуется: коммерческая тайна.
        throw new UnsupportedOperationException("Implementation not published");
    }
    ...
    public static class SortableComponentAddEvent extends ComponentEvent<QuestionnaireSortableLayout> {

        private final List<Component> components;

        public SortableComponentAddEvent(QuestionnaireSortableLayout source, boolean fromClient, List<Component> components) {
            // Реализация не публикуется: коммерческая тайна.
            throw new UnsupportedOperationException("Implementation not published");
        }
    ...
    public static class SortableComponentDeleteEvent extends ComponentEvent<QuestionnaireSortableLayout> {

        private final List<Component> components;

        public SortableComponentDeleteEvent(QuestionnaireSortableLayout source, boolean fromClient, List<Component> components) {
            // Реализация не публикуется: коммерческая тайна.
            throw new UnsupportedOperationException("Implementation not published");
        }
    ...
    public static class SortableComponentReorderEvent extends ComponentEvent<QuestionnaireSortableLayout> {

        private final List<Component> components;

        public SortableComponentReorderEvent(QuestionnaireSortableLayout source, boolean fromClient, List<Component> components) {
            // Реализация не публикуется: коммерческая тайна.
            throw new UnsupportedOperationException("Implementation not published");
        }
    ...
    public static class ChooseEvent
            extends ComponentEvent<QuestionnaireSortableLayout> {
        public ChooseEvent(QuestionnaireSortableLayout source,
                           boolean fromClient) {
            // Реализация не публикуется: коммерческая тайна.
            throw new UnsupportedOperationException("Implementation not published");
        }
    ...
    public static class UnchooseEvent
            extends ComponentEvent<QuestionnaireSortableLayout> {
        public UnchooseEvent(QuestionnaireSortableLayout source,
                             boolean fromClient) {
            // Реализация не публикуется: коммерческая тайна.
            throw new UnsupportedOperationException("Implementation not published");
        }
    ...
    public static class ChangeEvent
            extends ComponentEvent<QuestionnaireSortableLayout> {
        public ChangeEvent(QuestionnaireSortableLayout source,
                           boolean fromClient) {
            // Реализация не публикуется: коммерческая тайна.
            throw new UnsupportedOperationException("Implementation not published");
        }
